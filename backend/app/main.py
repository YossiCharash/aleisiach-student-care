...
from backend.app.routes.functional_report import router as functional_report_router
...
from backend.app.routes.program_plans import router as program_plans_router
from backend.app.routes.reception_report import router as reception_report_router
...
def create_app(bootstrap: Bootstrap | None = None) -> FastAPI:
    ...
    app.include_router(program_plans_router)
