...
- [x] מסך תלמיד — טאב 3 (סיכום עו"ס, כתיבה למנהל בלבד)
...
- [x] בדיקות: Vitest + RTL + Playwright E2E — עשן ציבורי (כניסה/ניתוב/שכחתי-סיסמה/404) **וגם זרימות מאומתות מאחורי כניסה** (מנהל/מדריך/מורה-מקצועי מול seed: רשימת תלמידים, 4 טאבים, הגדרות, ארכיון, שינוי-סיסמה, RBAC), ב-CI
...
- [x] נתוני דמו (seed) לכל התפקידים והתלמידים — `python -m backend.app.seed` (אידמפוטנטי): 3 תפקידים, 2 סדנאות, 3 תלמידים, טקסונומיה מלאה, ישיבה+פרטים+סיכום עו"ס
